...
'Reg e-mail'			=> 'Благодарим за регистрацию. На указанный адрес электронной почты высланы инструкции по активации вашей учётной записи. Письмо обычно приходит через несколько минут. <b>Проверьте папку <big><big><big>"Спам"</big></big></big></b> в своём ящике. Если письмо не пришло в течении суток, обратитесь к администратору форума: %s.',
...
'Username'			=> 'Логин',
'realName'                      => 'ФИО',
'realName help'                 => 'Ваше имя',
'realPhone'                     => 'Номер телефона',
'realPhone help'                => 'Будет виден только оргам и админам!',    
